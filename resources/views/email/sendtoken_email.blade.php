    ...
    <div class="container">
        ...
        <section>
          ...
          {{--   <p><a href="{{ url('verify-token/' . $token) }}" style="text-decoration: none; font-size:13px; font-weight:bold; color:blue;">Verifikasi Token</a></p> --}}
            <p><strong>Link Website : </strong> <a href="http://kubikaexpo.id/change-password/v1/confirmation" style="text-decoration: none; font-size:13px; font-weight:bold; color:blue;">kubikaexpo.id</a></p>
