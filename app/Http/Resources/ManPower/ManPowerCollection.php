...
{
    /**
     * Format setiap baris man power.
     */
    public function toArray($request): array
    {
        return $this->collection->map(function ($manPower) {
            return [
                'id'                           => $manPower->id,
    ...
    /**
     * Tambahkan meta aggregate (totals) ke dalam respons JSON.
     */
    public function with(Request $request): array
    {
        ...
        return [
            'meta' => [
                'total_current_salary'   => $totalCurrent,   // gaji pokok
                'total_overtime_salary'  => $totalOvertime,  // lembur
                'total_man_power_cost'   => $totalCost,      // gabungan (== costProgress)
