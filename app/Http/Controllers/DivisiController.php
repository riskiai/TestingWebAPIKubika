...
class DivisiController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return MessageActeeve::success("Divisi {$divisi->name} has been successfully created with kode_divisi {$divisi->kode_divisi}");
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        $divisi = Divisi::find($id);
        if (!$divisi) {
            return MessageActeeve::notFound('Divisi not found!');
        }
        ...
        try {
            ...
            DB::commit();
            return MessageActeeve::success("Divisi {$divisi->name} has been updated");
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            DB::commit();
            return MessageActeeve::success("Divisi {$divisi->name} has been deleted");
        } catch (\Throwable $th) {
